...
" Normal mode
let s:N1 = [ 'NONE' , '#6f8e9a' , 8 , 12 ]
let s:N2 = [ 'NONE' , '#2d4963' , 8 ,  4 ]
let s:N3 = [ '#a3a69a' , 'NONE' , 7 ,  0 ]

" Insert mode
let s:I1 = [ 'NONE' , '#9dae71' , 8 , 10 ]
let s:I2 = [ 'NONE' , '#3b4a35' , 8 ,  2 ]
let s:I3 = [ '#a3a69a' , 'NONE' , 7 ,  0 ]

" Visual mode
let s:V1 = [ 'NONE' , '#d8c27a' , 8 , 11 ]
let s:V2 = [ 'NONE' , '#4d3c2e' , 8 ,  3 ]
let s:V3 = [ '#a3a69a' , 'NONE' , 7 ,  0 ]

" Replace mode
let s:R1 = [ 'NONE' , '#b59cd8' , 8 , 13 ]
let s:R2 = [ 'NONE' , '#564059' , 8 ,  5 ]
let s:R3 = [ '#a3a69a' , 'NONE' , 7 ,  0 ]
...
let g:airline#themes#crayon#palette.tabline = {
      \ 'airline_tab':     [ 'NONE' , '#6f8e9a' ,  8 , 12  , 'bold' ],
      \ 'airline_tabsel':  [ 'NONE' , '#6f8e9a' ,  8 , 12  , 'bold' ],
      \ 'airline_tabtype': [ 'NONE' , '#6f8e9a' ,  8 , 12  , 'bold' ],
      \ 'airline_tabfill': [ '#a3a69a' , 'NONE' ,  7 ,  0  , 'bold' ],
      \ 'airline_tabmod':  [ 'NONE' , '#9dae71' ,  8 , 10  , 'bold' ]
\ }
