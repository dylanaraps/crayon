...
" Inactive mode
let s:IN1 = [ 'NONE' , '#1f1f1f' , 7 , 8 ]
let s:IN2 = [ 'NONE' , 'NONE' , 7 , 0 ]
...
let g:airline#themes#crayon#palette.tabline = {
      ...
      \ 'airline_tabfill': [ 'NONE' , 'NONE' ,  7 ,  0  , 'bold' ],
