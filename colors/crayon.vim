...
if &t_Co >= 256 || has("gui_running")
    ...
    hi rubyStringDelimiter ctermbg=NONE ctermfg=11 cterm=NONE guibg=NONE guifg=#d8c27a gui=NONE
elseif &t_Co == 8 || $TERM !~# '^linux' || &t_Co == 16
    ...
    hi rubyStringDelimiter ctermbg=NONE ctermfg=yellow cterm=NONE
endif
