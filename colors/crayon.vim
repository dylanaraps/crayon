...
if &t_Co >= 256 || has("gui_running")
    ...
    hi Comment ctermbg=NONE ctermfg=8 cterm=NONE guibg=NONE guifg=#2C3038 gui=NONE
    ...
    hi Todo ctermbg=8 ctermfg=11 cterm=NONE guibg=#2C3038 guifg=#d8c27a gui=NONE
    ...
    hi StatusLine ctermbg=NONE ctermfg=8 cterm=NONE guibg=NONE guifg=#2C3038 gui=NONE
    ...
    hi TabLineFill ctermbg=NONE ctermfg=8 cterm=NONE guibg=NONE guifg=#2C3038 gui=NONE
    hi TabLineSel ctermbg=NONE ctermfg=8 cterm=NONE guibg=NONE guifg=#2C3038 gui=NONE
    ...
    hi CursorLine ctermbg=NONE ctermfg=8 cterm=NONE guibg=NONE guifg=#2C3038 gui=NONE
    hi LineNr ctermbg=NONE ctermfg=8 cterm=NONE guibg=NONE guifg=#2C3038 gui=NONE
    hi CursorLineNr ctermbg=NONE ctermfg=8 cterm=NONE guibg=NONE guifg=#2C3038 gui=NONE
    ...
    hi Visual ctermbg=8 ctermfg=7 cterm=NONE guibg=#2C3038 guifg=#a3a69a gui=NONE
    hi VisualNOS ctermbg=NONE ctermfg=1 cterm=NONE guibg=NONE guifg=#401f1f gui=NONE
    hi Pmenu ctermbg=8 ctermfg=7 cterm=NONE guibg=#2C3038 guifg=#a3a69a gui=NONE
    ...
    hi Folded ctermbg=NONE ctermfg=8 cterm=NONE guibg=NONE guifg=#2C3038 gui=NONE
    hi WildMenu ctermbg=10 ctermfg=0 cterm=NONE guibg=#9dae71 guifg=#101112 gui=NONE
    hi SpecialKey ctermbg=NONE ctermfg=8 cterm=NONE guibg=NONE guifg=#2C3038 gui=NONE
    hi DiffAdd ctermbg=NONE ctermfg=10 cterm=NONE guibg=NONE guifg=#9dae71 gui=NONE
    hi DiffChange ctermbg=NONE ctermfg=8 cterm=NONE guibg=NONE guifg=#2C3038 gui=NONE
    ...
    hi MatchParen ctermbg=8 ctermfg=0 cterm=NONE guibg=#2C3038 guifg=#101112 gui=NONE
    ...
    hi ColorColumn ctermbg=8 ctermfg=8 cterm=NONE guibg=#2C3038 guifg=#2C3038 gui=NONE
    hi signColumn ctermbg=NONE ctermfg=12 cterm=bold guibg=NONE guifg=#6f8e9a gui=bold
    hi ErrorMsg ctermbg=NONE ctermfg=8 cterm=NONE guibg=NONE guifg=#2C3038 gui=NONE
    ...
    hi Cursor ctermbg=NONE ctermfg=8 cterm=NONE guibg=NONE guifg=#2C3038 gui=NONE
    hi Structure ctermbg=NONE ctermfg=13 cterm=NONE guibg=NONE guifg=#b59cd8 gui=NONE
    hi CursorColumn ctermbg=8 ctermfg=15 cterm=NONE guibg=#2C3038 guifg=#dfe7d7 gui=NONE
