...
if &t_Co >= 256 || has("gui_running")
	...
	set background=dark
		...
		hi markdownCode ctermbg=NONE ctermfg=12 cterm=NONE guibg=NONE guifg=#7495b6 gui=NONE
		hi markdownCodeBlock ctermbg=NONE ctermfg=12 cterm=NONE guibg=NONE guifg=#7495b6 gui=NONE
		hi markdownCodeDelimiter ctermbg=NONE ctermfg=4 cterm=NONE guibg=NONE guifg=#2d4963 gui=NONE
...
set t_Co=16
	...
	set background=dark
		...
		hi markdownCode ctermbg=NONE ctermfg=blue cterm=NONE
		hi markdownCodeBlock ctermbg=NONE ctermfg=blue cterm=NONE
		hi markdownCodeDelimiter ctermbg=NONE ctermfg=darkblue cterm=NONE
